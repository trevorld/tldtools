...
check_github_labels <- function() {
    ...
    if (length(only_in_df))
        message <- c(message,
                     "x" = paste("GitHub has extra labels:",
    ...
    if (length(only_in_tld))
        message <- c(message,
                     "x" = paste("GitHub is missing labels: ",
                                 paste(only_in_tld, collapse = ", ")))
    else
    ...
    if (length(descriptions_different))
        message <- c(message,
                     "x" = paste("Different label descriptions: ",
    ...
    if (length(colors_different))
        message <- c(message,
                     "x" = paste("Different label colors: ",
